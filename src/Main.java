public class Main
{
    public static void main(String args[])
    {
        ...
        if (game.tryMovingPieceAllBoard(piece_id)) {
            System.out.println("\nPiece [" + Integer.toString(piece_id) + "] of type '"+ knight.getClass().getName() +"' successful moved across all Chess Board:");
        ...
        System.out.println("Piece move " + Integer.toString(knight.getMovesCount()) + " times.\n");
